...
(function() {
    ...
    function initializeCardJson() {
        var json = {
            ...
            "297": "297 羊農 アクションで羊を取るたびに、追加で羊1をストックから得る。いつでも（繁殖フェイズを除く）羊3を牛1と猪1に交換できる。",
            ...
            "298": "298 羊番 石の家に住み次第これ以降のラウンドのスペースに羊を1頭ずつ置く。これらのラウンドのはじめにその羊を得る。（カードを出したときすでに石の家ならばすぐに羊を置く）",
