...
<div id="ja-text-3" title="3. 調理場"><p style="font-style:italic">コスト: 4x<img align="absmiddle" src="img/pionArgile16.png"> or discard 1 Fireplace</p>あなたはいつでも、作物や動物を以下の通り食料に換えられる。野菜:食料3、羊:食料2、猪:食料3、牛:食料4。「パンを焼く」のアクションでは、小麦1を食料3に換えられる。<br>*大きい進歩のかまどをアップグレードする場合、元のかまどは大きい進歩置き場に返す。小さい進歩の簡易かまどをアップグレードする場合、元の簡易かまどはゲームから取り除く。<br>*あなたは、複数個の調理場を所有できる。<br>*このカードで、動物や野菜を同時にいくらでも食料にできる。「パンを焼く」場合は、一度に小麦をいくつでも食料にできる。三つ足やかんの能力を起動するために、パンを焼くのと同時に他の品物を食料にしてもよい。<br>*調理場は暖炉ではない。<br>*アクションスペースから動物を入手した場合、それを牧場に入れるスペースがなくても、牧場に入れずにただちに食料に換えることができる。<br>*収穫の繁殖フェイズの間は、動物を食料に換えられない。最後の収穫の繁殖フェイズの後は、ただちにゲーム終了となるため、最後の繁殖フェイズで入手した動物を食料に換えることはできない。</div>\
<div id="ja-text-4" title="4. 調理場"><p style="font-style:italic">コスト: 5x<img align="absmiddle" src="img/pionArgile16.png"> or discard 1 Fireplace</p>あなたはいつでも、作物や動物を以下の通り食料に換えられる。野菜:食料3、羊:食料2、猪:食料3、牛:食料4。「パンを焼く」のアクションでは、小麦1を食料3に換えられる。<br>*大きい進歩のかまどをアップグレードする場合、元のかまどは大きい進歩置き場に返す。小さい進歩の簡易かまどをアップグレードする場合、元の簡易かまどはゲームから取り除く。<br>*あなたは、複数個の調理場を所有できる。<br>*このカードで、動物や野菜を同時にいくらでも食料にできる。「パンを焼く」場合は、一度に小麦をいくつでも食料にできる。三つ足やかんの能力を起動するために、パンを焼くのと同時に他の品物を食料にしてもよい。<br>*調理場は暖炉ではない。<br>*アクションスペースから動物を入手した場合、それを牧場に入れるスペースがなくても、牧場に入れずにただちに食料に換えることができる。<br>*収穫の繁殖フェイズの間は、動物を食料に換えられない。最後の収穫の繁殖フェイズの後は、ただちにゲーム終了となるため、最後の繁殖フェイズで入手した動物を食料に換えることはできない。</div>\
...
<div id="ja-text-7" title="7. 製陶所"><p style="font-style:italic">コスト: 2x<img align="absmiddle" src="img/pionArgile16.png">2x<img align="absmiddle" src="img/pionPierre16.png"></p>収穫のたびに木材最大1を食料2にできる。ゲーム終了時に木材3/5/7でそれぞれ1/2/3点のボーナスを得る。<br>*ゲーム終了時、雑木林と林務官の上にある木材はボーナス計算に数える。 骨細工 と資材商人 の上にある木材はゲーム終了時のボーナス計算には数えない。</div>\
<div id="ja-text-8" title="8. 家具製作所"><p style="font-style:italic">コスト: 2x<img align="absmiddle" src="img/pionBois16.png">2x<img align="absmiddle" src="img/pionPierre16.png"></p>収穫のたび、あなたは製陶所を使ってレンガ最大1を食料2にできる。ゲーム終了時、レンガ3/5/7でボーナス点1/2/3を得る。</div>\
...
<div id="ja-text-14" title="14. パン焼き暖炉"><p style="font-style:italic">コスト: なし<br>条件: discard 1 Oven</p>「パンを焼く」のアクションのたびに、小麦2つまでをそれぞれ食料5にできる。このカードを出してすぐに追加で「パンを焼く」アクションができる。<br>*暖炉1枚を返却する。レンガ暖炉と石の暖炉は大きい進歩置き場へ戻す。木の暖炉はゲームから取り除く。<br>*このカードを出したときに行うパンを焼くアクションでは、すでに出されている他の進歩でパンを焼いても良い。</div>\
...
<div id="ja-text-33" title="33. 陶器"><p style="font-style:italic">コスト: 1x<img align="absmiddle" src="img/pionArgile16.png"><br>*条件: a Oven</p>このカードを出すとすぐに食料2を得る。今後、製陶所は（あなたにとって）小さい進歩になり、コストなしで作れる。</div>\
...
<div id="ja-text-65" title="65. パン焼き部屋"><p style="font-style:italic">コスト: 2x<img align="absmiddle" src="img/pionPierre16.png"><br>*条件: discard 1 Oven</p>「パンを焼く」のアクションのたびに小麦2つまでをそれぞれ食料5にできる。このカードを出してすぐに追加で「パンを焼く」のアクションができる。<br>*パン焼き部屋は暖炉ではない。 パン焼き小屋へのアップグレードはできない。<br>*このカードを出したときに行うパンを焼くアクションでは、すでに出されている他の進歩でパンを焼いても良い。</div>\
<div id="ja-text-66" title="66. 村の井戸"><p style="font-style:italic">コスト: なし<br>条件: discard the Well</p>これ以降の3ラウンドのスペースに食糧1を置く。これらのラウンドの開始時に、あなたはその食糧を得る。<br>*大きい進歩の井戸が大きい進歩置き場に戻った後、村の井戸の所有者が再び井戸を買うことができる。<br>*井戸は5ラウンドにわたり1食糧ずつを供給する。村の井戸をプレイしたとき、これらの食糧はそのままにしてさらに3ラウンド分の食糧を追加で置く。これに加えてさらに井戸を再度プレイしたときは、さらに追加で（5ラウンド分の）食糧を置く。</div>\
...
<div id="ja-text-85" title="85. 調理コーナー"><p style="font-style:italic">コスト: なし<br>条件: discard 1 Cooking Hearth</p>あなたはいつでも、作物や動物を以下の通り食料に換えられる。野菜:食料4、羊:食料2、猪:食料3、牛:食料4。「パンを焼く」のアクションでは、小麦1を食料3に換えられる。<br>*大きい進歩の調理場をアップグレードする場合、元の調理場は大きい進歩置き場に返す。小さい進歩の調理場をアップグレードする場合、元の調理場はゲームから取り除く。<br>*調理コーナーは暖炉ではない。<br>*アクションスペースから動物を入手した場合、それを牧場に入れるスペースがなくても、牧場に入れずにただちに食料に換えることができる。<br>*収穫の繁殖フェイズの間は、動物を食料に換えられない。最後の収穫の繁殖フェイズの後は、ただちにゲーム終了となるため、最後の繁殖フェイズで入手した動物を食料に換えることはできない。</div>\
...
<div id="ja-text-122" title="122. 製材所"><p style="font-style:italic">コスト: なし<br>条件: discard the Joinery</p>収穫のたび、あなたは木材最大1を食料3にできる。ゲーム終了時、木材2/4/5でボーナス1/2/3点を得る。<br>*家具製作所をアップグレードしたら、家具製作所は（大きい進歩置き場に戻り）再び購入可能となる。<br>*製材所をプレイしている状態で家具製作所を再購入した場合、ゲーム終了時のボーナス点は製材所のみをカウントする。<br>*ゲーム終了時、雑木林および林務官の上にある木材はカウントする。骨細工、資材商人の上にある木材は無視する。</div>\
...
<div id="ja-text-128" title="128. 調理場"><p style="font-style:italic">コスト: なし<br>条件: discard 1 Fireplace</p>あなたはいつでも、作物や動物を以下の通り食料に換えられる。野菜:食料3、羊:食料2、猪:食料3、牛:食料4。「パンを焼く」のアクションでは、小麦1を食料3に換えられる。<br>*大きい進歩のかまどをアップグレードする場合、元のかまどは大きい進歩置き場に返す。小さい進歩の簡易かまどをアップグレードする場合、元の簡易かまどはゲームから取り除く。<br>*あなたは、複数個の調理場を所有できる。<br>*このカードで、動物や野菜を同時にいくらでも食料にできる。「パンを焼く」場合は、一度に小麦をいくつでも食料にできる。三つ足やかんの能力を起動するために、パンを焼くのと同時に他の品物を食料にしてもよい。<br>*調理場は暖炉ではない。<br>*アクションスペースから動物を入手した場合、それを牧場に入れるスペースがなくても、牧場に入れずにただちに食料に換えることができる。<br>*収穫の繁殖フェイズの間は、動物を食料に換えられない。最後の収穫の繁殖フェイズの後は、ただちにゲーム終了となるため、最後の繁殖フェイズで入手した動物を食料に換えることはできない。<br>*このカードは、小さい進歩としてプレイできる点を除いて、大きい進歩の調理場とまったく同じである。</div>\
